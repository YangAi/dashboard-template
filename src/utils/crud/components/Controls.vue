    ...
    <div class="right">
      ...
      >
        ...
        <v-list style="overflow-y:false;">
          ...
          <v-card-subtitle class="caption tw-text-gray-500">Use ";" to separate items when filter by list mode.</v-card-subtitle>
          <v-list-item
      ...
      <template v-if="['soft', 'both', 'filter'].includes(deleteMode) && deleteFilter">
